...
static inline NSString *PEPStringCCHashFunction(unsigned char *(function)(const void *data, CC_LONG len, unsigned char *md), CC_LONG digestLength, NSString *string)
{
...
@implementation PEPDownloadUtilities
...
+ (NSString *)md5WithString:(NSString *)string
{
    ...
    return PEPStringCCHashFunction(CC_MD5, CC_MD5_DIGEST_LENGTH, string);
}
